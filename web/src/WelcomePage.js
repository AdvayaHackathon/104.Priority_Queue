...
export default function CareChainWelcome() {
  ...
  const features = [
    {
      ...
      description: "Blockchain-powered secure storage of complete medical histories",
      icon: (
    ...
    },
    {
      ...
      description: "Automatically detect adverse drug interactions and suggest alternatives",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Receive notifications for patients needing immediate attention",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100">
      ...
      <header className="bg-white shadow-md">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <nav>
            ...
            >
              <li><a href="#" className="text-purple-600 font-medium">Home</a></li>
        ...
        <div className="flex flex-col lg:flex-row items-center relative z-10">
          ...
          >
            <h2 className="text-5xl font-bold text-gray-800 leading-tight mb-6">
              Revolutionizing <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-indigo-600">Healthcare</span> for Doctors
            </h2>
            <p className="text-xl text-gray-600 mb-8">
              Access secure patient records, detect adverse drug interactions, and receive priority alerts for patients requiring immediate attention.
            </p>
            <div className="flex space-x-4">
              <button className="bg-gradient-to-r from-purple-600 to-indigo-700 hover:from-purple-700 hover:to-indigo-800 text-white font-medium py-3 px-8 rounded-lg shadow-lg hover:shadow-xl transition-all">
                Get Started
              </button>
            ...
            <div className="mt-12">
              ...
              <div className="flex flex-wrap items-center space-x-8">
                <div className="text-gray-400 font-semibold">Memorial Health</div>
      ...
      <section className="py-20 relative">
        ...
        <div className="container mx-auto px-6 relative z-10 pt-12">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Powerful Features for Healthcare Professionals</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              CareChain.ai combines blockchain security with AI-powered insights to transform patient care management.
            </p>
          </motion.div>
      ...
      <section className="bg-white py-20">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">What Healthcare Professionals Say</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-purple-50 rounded-xl p-8 border border-purple-100">
              ...
              <p className="text-gray-600 italic">"CareChain.ai has transformed how I manage patient data. The drug interaction alerts have prevented several potential adverse events."</p>
            ...
            <div className="bg-purple-50 rounded-xl p-8 border border-purple-100">
              ...
              <p className="text-gray-600 italic">"The security of patient data is paramount in our practice. CareChain's blockchain technology gives us peace of mind while improving our workflow."</p>
              <div className="flex mt-4 text-yellow-400">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
            ...
            <div className="bg-purple-50 rounded-xl p-8 border border-purple-100">
              ...
              <p className="text-gray-600 italic">"The priority alert system has been a game-changer for our practice. We're able to respond to critical cases much faster than before."</p>
              <div className="flex mt-4 text-yellow-400">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">
              Join thousands of healthcare professionals who are using CareChain.ai to provide better patient care through secure, AI-enhanced medical data management.
            </p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-8 md:mb-0">
              ...
              <p className="text-gray-400 mt-4 max-w-md">
                Revolutionizing healthcare with blockchain security and AI-powered insights for better patient care.
              </p>
              <div className="mt-6">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">© 2025 CareChain.ai. All rights reserved.</p>
